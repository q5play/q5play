...
**_For use in Computer Science (CS) education, see the [q5play Educational License](https://q5play.org/teach)._**

## 1. License Grant

The Licensee is granted a non-exclusive, world-wide, royalty-free right to use the q5play software library ("Content") for **personal, professional, and commercial purposes**, subject to the following restrictions.

### 1a. Permitted Commercial Use

The Licensee may use the Content to create, publish, and sell software, games, or applications without the requirement to make their own application source code public or open source.
...
- **Permitted Use:** The Content may be used to create interactive educational media for other subjects (e.g., teaching math, cooking, or history), provided the application does not instruct the user on how to code or use q5play.
...
Any use for CS education requires the [q5play Educational License](https://q5play.org/teach).
...
The Licensee must publicly display appropriate credit to the Licensor. Use of the "made with q5play" Loading Screen is required for all published work, unless the work is published on an online code editing platform or other web app that was approved by the Licensor to be exempt from this requirement.
...
Any individual or entity using q5play is required to comply with this Agreement. Use of q5play constitutes acceptance of these terms.

## 3. "Learn q5play" Interactive Textbook Access

The Licensee is granted access to the ["Learn q5play"](https://q5play.org/learn) interactive textbook for personal learning and evaluation only. Use of these materials for group instruction or classroom settings is prohibited without an Educational License.
...
The Licensor shall not be liable for any damages suffered by the Licensee resulting from the use or inability to use the Content. Licensees must comply with all applicable laws and are fully liable for any content they create with q5play.
