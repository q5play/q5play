# q5play Personal License

This License Agreement ("Agreement") is made between Quinton Ashley, the sole copyright owner of q5play ("Licensor") and an individual, organization, or company ("Licensee") that is using q5play for free.

For commercial game development, see the [q5play Professional License](https://q5play.org/pro).

For educational use, see the [q5play Educational License](https://q5play.org/teach).

## 1. License Grant

The Licensee is granted the right to use the q5play software library ("Content") for personal use, subject to the following restrictions.
...
The Licensee must also include a copy of this q5play License alongside the Content in the open source work.

These requirements apply to the entirety of work that uses the Content, not just q5play-related sections. It is the Licensee's responsibility to ensure that they understand the consequences of licensing their work as open source.
...
Any modification, enhancement, or adaptation of the Content ("Derivative Work") shall be owned by the Licensor. Derivative Works must be created for the sole purpose of improving the Content, for the benefit of all users of q5play.
...
The Licensee must notify and distribute Derivative Works to the Licensor via GitHub PR, email (info@q5play.org), or Discord post/message and not by any other means.
...
The Licensee must purchase a [q5play Professional License](https://q5play.org/pro) subscription to use the Content commercially.
...
Educational Use of the Content requires the [q5play Educational License](https://q5play.org/teach), even if the Content is used indirectly through a third-party provider.
...
Any individual, organization, or company that is not paying licensing fees for their use of q5play is required to comply with this Agreement. Use of q5play constitutes acceptance of this Agreement.

## 3. Licensee Consent

Licensees optionally consent to q5play using Google Analytics to track how they use q5play. To revoke this consent, you can use a browser extension to block Google Analytics or set `window._q5play_gtagged = false;` before loading q5play.

## 4. "Learn q5play" Interactive Textbook Access

The Licensee is also granted access to the ["Learn q5play"](https://q5play.org/learn) interactive textbook located at q5play.org/learn, for personal learning and evaluation only, in compliance with the [q5play.org Terms of Service](https://q5play.org/account/tos.md).
...
Licensees must comply with all applicable laws and regulations when using q5play. It is illegal to create content that infringes on the rights of others. Licensees are fully liable for any content they create with q5play.
