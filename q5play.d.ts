...
class Sprite {
	 ...
	 */
	constructor(x?: number, y?: number, w?: number, h?: number, type?: string, ...args: any[]);
	/**
	...
	set type(val: string);
	/**
	 * The sprite's physics type.
	 *
	 * The physics type can be one of the following strings:
	 * DYNAMIC (default), STATIC, KINEMATIC, "none".
	 *
	 ...
	 * when users let q5play automatically manage the frame cycle.
	 * @type {Boolean}
	 * @default true
	 */
	 ...
	 *
	 * In q5play a sprite's center (position) is always the same as its
	 ...
	 *
	 * Set pixelPerfect to true to make q5play always display sprites
	 ...
	 */
	get tint(): Q5.Color;
	set tintColor(val: Q5.Color);
	/**
	 * Alias for sprite.tint
	 * @type {Q5.Color}
	 * @default undefined
	 */
	get tintColor(): Q5.Color;
	/**
	 ...
	 */
	get visible(): boolean;
	set pos(val: Q5.Vector);
	/**
	 * The position vector {x, y}
	 * @type {Q5.Vector}
	 */
	get pos(): Q5.Vector;
	set position(val: Q5.Vector);
	/**
	 * The position vector {x, y}
	 * @type {Q5.Vector}
	 */
	...
	/**
	 * Runs before each physics update by default, when q5play is automatically
	...
	/**
	 * Runs at the end of the q5play frame cycle.
	 *
	 * Users should not directly run this function.
	 * @type {Function}
	 */
	get postDraw(): Function;
	set velocity(val: Q5.Vector);
	/**
	 * The sprite's velocity vector {x, y}
	 * @type {Q5.Vector}
	 * @default {x: 0, y: 0}
...
/**
 * @class
 * @extends Array<Q5.Image>
 */
class Ani extends Array<Q5.Image> {
	/**
	 * <a href="https://q5play.org/learn/animation.html">
	 ...
	 * the first image frame and last frame index (frames must be a string)
	 ...
	 * let sequence = new Ani("walk0001.png", "walk0010.png");
	 * let spriteSheet = new Ani("spritesheet.png", 8, { w: 32, h: 32 });
	 */
	constructor(...args: Q5.Image[]);
	/**
	 * Load an image sequence animation.
	 * @param name - Optional animation name
	 * @param imageUrl - Path to the first image in the sequence
	 * @param frames - Path to the last image in the sequence (must be a string)
	 */
	constructor(name: string, imageUrl: string, frames: string);
	constructor(imageUrl: string, frames: string);
	/**
	 * Load a sprite sheet animation.
	 * @param name - Optional animation name
	 * @param spriteSheetUrl - Path to the sprite sheet image
	 * @param frames - Number of frames in the sprite sheet
	 * @param atlas - Optional atlas object defining frame dimensions and layout
	 */
	constructor(name: string, spriteSheetUrl: string, frames: number, atlas?: object);
	constructor(spriteSheetUrl: string, frames: number, atlas?: object);
	/**
...
class Group extends Array<Sprite> {
	/**
	 * <a href="https://q5play.org/learn/group.html">
	 ...
	 * marked as removed and deleted from q5play's internal memory, the
	 * `q5play.groups` array. Every sprite in the group will be removed
...
class Tiles {
	/**
	 * <a href="https://q5play.org/learn/tiles.html">
...
function createCanvas(...args: any[]): Q5.Renderer;
/**
 * @class
 */
class Canvas {
	/**
	 * q5play adds some extra functionality to the `createCanvas`
	 * function. See the examples below.
	 *
	 * Creating a canvas in q5play disables the browser's default
...
class _Touch extends InputDevice {
	/**
	 * <a href="https://q5play.org/learn/input.html">
...
class _Contros extends Array<Contro> {
	 ...
	 * @returns {Boolean} true if the controller should be added to this q5play controllers array
	 */
	 ...
	 * @type {Function}
	 * @param {Gamepad} gamepad
	 * @returns {Boolean} true if the controllers should be removed from this q5play controllers array
	 */
